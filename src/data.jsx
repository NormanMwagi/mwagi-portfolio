...
export const projects = [
  {
    ...
    url: 'https://comfy-ke.netlify.app/cart',
    github: 'https://github.com/NormanMwagi/Comfy-Online-Store',
    title: 'first project',
    text: 'An online shop where you can sign up, login, view items, filter or search with different criteria, add to cart, order and Track your order. Technologies used React JS, Redux, tanstack/react-query, react-router, daisy-UI and tailwind css.',
  },
  {
    id: nanoid(),
    img: 'https://images.pexels.com/photos/326503/pexels-photo-326503.jpeg?auto=compress&cs=tinysrgb&w=800',
